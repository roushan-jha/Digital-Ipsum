...
const Home = () => {
  return (
    <div>
        <div className='w-full h-screen bg-gray-800 flex flex-col justify-end items-start text-white px-28 pt-10 pb-36'>
            <h1 className='font-semibold text-6xl py-8'>Investing made easy</h1>
            <p className='text-lg font-light w-1/2 pb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque quisquam dicta non laboriosam exercitationem ab numquam tempora eos cum voluptate.</p>
